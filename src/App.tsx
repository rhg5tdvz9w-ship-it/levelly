              ...
              <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start",cursor:"pointer",padding:"14px 16px" }} onClick={()=>setExpandedConcept(expandedConcept===ci?null:ci)}>
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ display:"flex",gap:6,flexWrap:"wrap" as const }}>
                    ...
                    {/* BC2.5.1: hook_type chip — surface so producer can verify 4 distinct hooks across concepts at a glance */}
                    {(c as any).hook_type&&<span style={{ fontSize:10,padding:"2px 8px",borderRadius:4,background:D.purpleBg,color:D.purple,border:`0.5px solid ${D.purpleBdr}`,fontWeight:500 }}>{(c as any).hook_type}</span>}
