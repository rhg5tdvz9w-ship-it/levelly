...
hook_format detection (Deploy Y2): "live-action" if opening shot shows a real human (photo-realistic UGC). "in-game" if opening is game art. Critical for UGC pattern synthesis downstream.
